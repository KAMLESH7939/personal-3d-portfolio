...
const Myapproach = () => {
  return (
    <section className="pl-3 pr-3 pb-2 pt-2 mx-auto space-y-10 space-x-5 min-h-[80vh]">
      ...
      <section className="w-full h-full flex flex-col gap-3 bg-primary">
        <h1 className=" text-white text-center font-poppins font-medium mb-[1rem] mt-[1rem] honeysingh">
          <div className="flex flex-row justify-center items-center gap-2 "> <div className="honey text-[2.3rem]">My</div> <span className="text-happy text-[2.7rem]">Approach</span> </div>
        </h1>
        <div className="my-[2rem] ml-[1rem] mr-[1rem] flex flex-col lg:flex-row items-center justify-center gap-4">
          <Card
...
const Card = ({
  ...
  return (
    <div
      ...
      className="border border-black/[0.2] group/canvas-card flex items-center justify-center dark:border-white/[0.2]  max-w-sm w-full mx-auto p-4 relative lg:h-[18rem] xl:h-[33rem] rounded-3xl  "
    >
    ...
    <div>
      ...
      <button className="relative inline-flex overflow-hidden rounded-full p-[1px] ">
       ...
       bg-[conic-gradient(from_90deg_at_50%_50%,#E2CBFF_0%,#393BB2_50%,#E2CBFF_100%)]"
        />
        <span
          className="text-white inline-flex h-full w-full cursor-pointer items-center 
